...
public class DeletarServidorTerceirizado extends JFrame {
	...
	public DeletarServidorTerceirizado() {
		...
		PlanodeFundo.add(titulo = new JLabel("Deletar Servidor Terceirizado"));
