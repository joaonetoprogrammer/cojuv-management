...
public class DeletarGrupos extends JFrame {
	...
	public DeletarGrupos() {
		...
		PlanodeFundo.add(titulo = new JLabel("Deletar Grupos"));
		...
		PlanodeFundo.add(nome = new JLabel("*Nome do Grupo" + ": "));
