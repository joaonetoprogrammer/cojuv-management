...
public class MenuServidorTerceirizado extends JFrame {
	...
	public MenuServidorTerceirizado() {
		...
		PlanodeFundo.add(titulo = new JLabel(
				"Menu de Opções Servidor Terceirizado"));
		titulo.setFont(minhafont);
		Dimension sizetitulo = titulo.getPreferredSize();
		titulo.setBounds(330, 50, sizetitulo.width, sizetitulo.height);
