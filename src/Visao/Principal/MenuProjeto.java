...
public class MenuProjeto extends JFrame {
	...
	public MenuProjeto() {
		...
		ControleFechar fechar = new ControleFechar();
		...
		PlanodeFundo.add(titulo = new JLabel("Menu de Opções Projeto"));
		titulo.setFont(minhafont);
		Dimension sizetitulo = titulo.getPreferredSize();
		titulo.setBounds(405, 50, sizetitulo.width, sizetitulo.height);
