...
public class MenuServidorPublico extends JFrame {
	...
	public MenuServidorPublico() {
		...
		PlanodeFundo
				.add(titulo = new JLabel("Menu de Opções Servidor Publico"));
		...
		rodape.setBounds(400, 604, sizerodape.width, sizerodape.height);
		...
		PlanodeFundo.add(deletar = new JButton("Deleetar"));
		...
		// Adicionando Controle dos Botões
