...
public class MenuContatosGeral extends JFrame {
	...
	public MenuContatosGeral() {
		...
		PlanodeFundo.add(titulo = new JLabel("Menu de Opções Outros Contatos"));
		...
		titulo2.setBounds(250, 90, sizetitulo2.width, sizetitulo2.height);
