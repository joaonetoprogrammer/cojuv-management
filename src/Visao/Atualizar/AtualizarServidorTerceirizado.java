...
public class AtualizarServidorTerceirizado extends JFrame {
	...
	public static JTextField empresa1;
	...
	public AtualizarServidorTerceirizado() {
		...
		PlanodeFundo.add(titulo = new JLabel(
				"Atualização Servidor Terceirizado"));
		titulo.setFont(minhafont);
		Dimension sizetitulo = titulo.getPreferredSize();
		titulo.setBounds(350, 50, sizetitulo.width, sizetitulo.height);
		...
		atualizar.setBounds(280, 520, 300, 50);
		...
		voltar.setBounds(630, 520, 300, 50);
