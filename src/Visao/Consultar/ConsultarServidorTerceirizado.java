...
public class ConsultarServidorTerceirizado extends JFrame {
	...
	public ConsultarServidorTerceirizado() {
		...
		PlanodeFundo
				.add(titulo = new JLabel("Consultar Servidor Terceirizado"));
		titulo.setFont(minhafont);
		Dimension sizetitulo = titulo.getPreferredSize();
		titulo.setBounds(340, 50, sizetitulo.width, sizetitulo.height);
		...
		DefaultTableModel Modelo = new DefaultTableModel(new String[] {
				"Código", "Empresa Terceirizada", "Nome", "Telefone", "E-mail",
				"Lotação", "Matrícula", "Função", "Facebook" }, 0) {
		...
		// Coluna 6
		Tabela.getColumnModel().getColumn(6).setPreferredWidth(190);
		...
		// Coluna 6
		Tabela.getColumnModel().getColumn(8).setPreferredWidth(250);
		...
		ServidorTerceirizado tc = new ServidorTerceirizado();
		tc.AtualizaTable();
